...
export const itNav: NavItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { label: 'Rosina „Rosi“ Hugendubel', href: '/it/soeldner/haubentaucher/Rosina' },
      { label: 'Tilly – Otillie Kreisch', href: '/it/soeldner/haubentaucher/Tilly' },
      { label: 'Tobalt', href: '/it/soeldner/haubentaucher/Tobalt' },
      { label: 'Vasil Schütze', href: '/it/soeldner/haubentaucher/Vasil' },
      { label: 'Wenzl aus Umseck', href: '/it/soeldner/haubentaucher/Wenzel' },
    ],
  },
  {
    label: 'Die Akademie',
